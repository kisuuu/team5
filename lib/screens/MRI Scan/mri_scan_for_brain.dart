...
import 'package:team_five/screens/bookings.dart';

class MriForBrain extends StatefulWidget {
  const MriForBrain({Key? key}) : super(key: key);

  @override
  State<MriForBrain> createState() => _MriForBrainState();
}

class _MriForBrainState extends State<MriForBrain> {
...
// List of items in our dropdown menu
  ...
  static final List<Animal> _animals = [
    Animal(
      id: 1,
      name: "MRI Scan For Brain",
    ),
    Animal(
      id: 2,
      name: "MRI Scan For Spine",
    ),
    Animal(
      id: 3,
      name: "MRI Scan For Joints",
    ),
    Animal(
      id: 4,
      name: "MRI Scan For Abdomen",
    ),
    Animal(
      id: 5,
      name: "MRI Scan For Pelvic region",
    ),
    Animal(
      id: 6,
      name: "MRI Scan For Breast",
    ),
    Animal(
      id: 7,
      name: "MRI Scan For Blood vessels",
    ),
    Animal(
      id: 8,
      name: "MRI Scan For Heart",
    ),
  ];
